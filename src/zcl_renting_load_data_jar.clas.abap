CLASS zcl_renting_load_data_jar DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_jar IMPLEMENTATION.

METHOD if_oo_adt_classrun~main.
DATA: lt_brands TYPE TABLE OF zrent_brands_jar,
lt_cars TYPE TABLE OF zrent_cars_jar,
lt_customers TYPE TABLE OF zrent_custom_jar.
...
DELETE FROM zrent_brands_jar.
INSERT zrent_brands_jar FROM TABLE @lt_brands.
SELECT * FROM zrent_brands_jar INTO TABLE @lt_brands.
out->write( sy-dbcnt ).
out->write( 'zrent_brands data inserted successfully!').


** CARS**
lt_cars = VALUE #( ( matricula = '1246GSA' marca = 'BMW' modelo = 'SERIE 4' color = 'BLANCO' motor = '2.5' potencia = '210' und_potencia = 'CV'
combustible = 'GASOLINA' consumo = '7.00' fecha_fabr = '20200418' puertas = '5' precio = '210' moneda = 'USD' alquilado = 'X' alq_desde =
'20241201' alq_hasta = '20241231' )
...
combustible = 'ELECTRIC' consumo = '00.00' fecha_fabr = '20200304' puertas = '3' precio = '140' moneda = 'USD' alquilado = 'X' alq_desde =
'20240701' alq_hasta = '20240708' )
( matricula = '2392JFH' marca = 'JEEP' modelo = 'GRAND CHEROKEE' color = 'BLANCO' motor = '3.6' potencia = '176' und_potencia = 'CV'
combustible = 'GASOLINA' consumo = '12.00' fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde =
...
combustible = 'GASOLINA' consumo = '7.00' fecha_fabr = '20200726' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde =
'20250120' alq_hasta = '20250202' )
( matricula = '2837SUF' marca = 'MERCEDES' modelo = 'CLASE C' color = 'AMARILLO' motor = '3.0' potencia = '220' und_potencia = 'CV'
combustible = 'GASOLINA' consumo = '6.00' fecha_fabr = '20200614' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde =
'20250202' alq_hasta = '20250203' )
( matricula = '2847JGH' marca = 'HONDA' modelo = 'CARENS' color = 'NEGRO' motor = '1.9' potencia = '180' und_potencia = 'CV'
combustible = 'DIESEL' consumo = '5.00' fecha_fabr = '20210716' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde =
'20250201' alq_hasta = '20250210' )
( matricula = '29348KJ' marca = 'MINI' modelo = 'CABRIO' color = 'AMARILLO' motor = '2.0' potencia = '240' und_potencia = 'CV'
combustible = 'ELECTRIC' consumo = '0.00' fecha_fabr = '20200812' puertas = '3' precio = '150'
moneda = 'USD' alquilado = 'X' alq_desde = '20240106' alq_hasta = '20240215' ) ).

DELETE FROM zrent_cars_jar.
INSERT zrent_cars_jar FROM TABLE @lt_cars.
SELECT * FROM zrent_cars_jar INTO TABLE @lt_cars.
out->write( sy-dbcnt ).
...
DELETE FROM zrent_custom_jar.
INSERT zrent_custom_jar FROM TABLE @lt_customers.
SELECT * FROM zrent_custom_jar INTO TABLE @lt_customers.
out->write( sy-dbcnt ).
